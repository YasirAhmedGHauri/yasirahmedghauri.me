...
class Elito_Tabs  extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-elito_tabs';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Tabs ', 'elito-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Elito Tabs  widget depended on.
	...
	*/
	...
	/**
	 * Register Elito Tabs  widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => esc_html__( 'Tabs  Options', 'elito-core' ),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __( 'Active Tabs', 'elito-core' ),
		...
		$this->add_control(
			'tabsItems_groups',
			[
				'label' => esc_html__( 'Tabs  Items', 'elito-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tabs_title' => esc_html__( 'Tabs ', 'elito-core' ),
					],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Background Color', 'elito-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tabs Content', 'elito-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
...
Plugin::instance()->widgets_manager->register( new Elito_Tabs () );