	...
	*/
	protected function render() {
	        ...
	        <div class="row align-items-center">
	        	<?php if ( $about_style == 'style-one') { ?>
	                ...
	                <div class="wpo-about-exprience-wrap">
                    	...
                    	<?php 
                    		if( $exp_number ) { echo '<h2>'.esc_html( $exp_number ).'</h2>'; }
                    		if( $exp_title ) { echo '<span>'.esc_html( $exp_title ).'</span>'; }
                    	?>
	                    </div>
	                    <div class="client">
	                        <?php
	                        	if( $client_number ) { echo '<h3><span class="odometer" data-count="100">'.esc_html( $client_number ).'</span>%</h3>'; }
	                        	if( $client_title ) { echo '<p>'.esc_html( $client_title ).'</p>'; }
	                         ?>
	                    </div>
	                </div>
	            </div>
	                    ...
	                    <div class="wpo-about-funfact">
	                        ...
	                        <div class="grid">
	                            <div class="grid-inner">
	                              <?php 
								            		if( $funfact_number ) { echo '<h3><span class="odometer" data-count="'.esc_attr( $funfact_number ).'">'.esc_html__( '00','elito-core' ).'</span>'.esc_html( $funfact_plus ).'</h3>'; } 
	    ...
	    <div class="line-shape-2">
	       <?php if( $shape2_url ) { echo '<img src="'.esc_url( $shape2_url ).'" alt="'.esc_url( $shape2_alt ).'">'; } ?>
	    </div>
		</div>
		<?php 
