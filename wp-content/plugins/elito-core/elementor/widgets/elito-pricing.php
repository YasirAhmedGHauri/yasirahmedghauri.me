	                    ...
	                    <div class="wpo-pricing-item">
	                        <div class="wpo-pricing-top">
	                            ...
	                            <div class="wpo-pricing-text">
	                               <?php 
										            	if( $pricing_amount ) { echo '<h2>'.esc_html( $pricing_amount ).'<span>'.esc_html( $pricing_month ).'</span></h2>'; }
										            	if( $pricing_desc ) { echo '<p>'.esc_html( $pricing_desc ).'</p>'; }
										            ?>
	                            </div>
	                        </div>
	                            ...
	                            <div class="wpo-pricing-bottom-text">
	                              <?php 
			                           if( $pricing_content ) { echo wp_kses_post( $pricing_content ); } 
						                     if( $button_text ) { echo ' <a class="price-btn" href="'.esc_url( $pricing_link ).'">'.esc_html( $button_text ).'</a>'; }
						                   	?>
	                            </div>
	                        </div>
	                    </div>
