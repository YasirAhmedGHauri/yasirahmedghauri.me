<?php
/*
 * Elementor Elito Product Widget
...
class Elito_Product extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-elito_product';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Product', 'elito-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Elito Product widget depended on.
	...
	*/
	...
	/**
	 * Register Elito Product widget controls.
    ...
    if ( $posts ) {
      ...
      $PostID[ __( 'No ID\'s found', 'elito' ) ] = 0;
		...
		$this->add_control(
			'product_limit',
			[
				'label' => esc_html__( 'Product Limit', 'elito-core' ),
		...
		$this->start_controls_section(
			'section_meta_style',
			[
				'label' => esc_html__( 'Meta', 'elito-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
...
Plugin::instance()->widgets_manager->register( new Elito_Product() );