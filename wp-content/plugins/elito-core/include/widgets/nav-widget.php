...
class elito_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-navigation-widget',
      ELITO_THEME_NAME_PLUGIN . esc_html__( ': Navigation', 'elito' ),
      array(
        'classname'   => 'link-widget',
        'description' => ELITO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays navigations list.', 'elito' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'elito' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'elito' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'elito' ),
    );
...
add_action( 'widgets_init', function() { register_widget( "elito_navigation_widget" ); } );
