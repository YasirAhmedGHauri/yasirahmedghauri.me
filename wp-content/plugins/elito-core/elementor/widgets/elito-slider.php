              ...
              <div class="container">
                  <div class="slide-content">
                      <div data-swiper-parallax="300" class="slide-title">
                          <h2>
                          	<?php
                           	if( $slider_toptitle ) { echo '<span>'.esc_html( $slider_toptitle ).'</span>'; } 
                          	if( $slider_title ) { echo esc_html( $slider_title ); }?>
                          </h2>
                      </div>
                      <div data-swiper-parallax="300" class="slide-sub-title">
                        <?php if( $slider_subtitle ) { echo '<h5>'.esc_html( $slider_subtitle ).'</h5>'; } ?>
                      </div>
