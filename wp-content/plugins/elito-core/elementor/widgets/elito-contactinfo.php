<?php
/*
 * Elementor Elito Contactinfo Widget
...
class Elito_Contactinfo extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-elito_contactinfo';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Contact Info', 'elito-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Elito Contactinfo widget depended on.
	...
	*/
	...
	/**
	 * Register Elito Contactinfo widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_contactinfo',
			[
				'label' => esc_html__( 'Contactinfo Options', 'elito-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( '24/7 customer support.', 'elito-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Contactinfo Icons', 'elito-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'contactinfo_title' => esc_html__( 'Contactinfo', 'elito-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Contactinfo BG', 'elito-core' ),
	        ...
	        <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
	            <div class="office-info-item">
	                ...
	                <div class="office-info-text">
	                    <?php 
				            	if( $contactinfo_title ) { echo '<h2>'.esc_html( $contactinfo_title ).'</h2>'; }
...
Plugin::instance()->widgets_manager->register( new Elito_Contactinfo() );