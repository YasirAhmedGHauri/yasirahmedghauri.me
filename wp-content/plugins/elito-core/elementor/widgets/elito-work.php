	        ...
	        <div class="wpo-work-wrap">
	          <?php
	            ...
	            <div class="wpo-work-item">
	                <ul>
	                	<?php 
	                		if( $work_date ) { echo '<li class="date">'.wp_kses_post( $work_date ).'</li>'; } 
	                		?>
	                    <li class="logo">
	                    	<?php if( $image_url ) { echo '<img src="'.esc_url( $image_url ).'" alt="'.esc_url( $image_alt ).'">'; } ?>
	                    </li>
	                    <?php 
	                    if( $work_title ) { echo '<li class="position">'.esc_html( $work_title ).'<span>'.wp_kses_post( $work_subtitle ).'</span></li>'; } 
				            	if( $link_text ) { echo ' <li class="link">'.$link_o.''.esc_html( $link_text ).''.$link_c.'</li>'; }
				             ?>
	                </ul>
	            </div>
	            <?php }
