...
class Elito_Button extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-elito_button';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Button', 'elito-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Elito Button widget depended on.
	...
	*/
	...
	/**
	 * Register Elito Button widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Button',
			[
				'label' => __( 'Button Options', 'elito-core' ),
			]
		);
		$this->add_control(
			'btn_style',
			[
				'label' => esc_html__( 'Button Style', 'elito-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'style-one' => esc_html__( 'Style One (Button)', 'elito-core' ),
					'style-two' => esc_html__( 'Style Two (Link With Text)', 'elito-core' ),
				],
				'default' => 'style-one',
				'description' => esc_html__( 'Select your Button style.', 'elito-core' ),
			]
		);
		$this->add_responsive_control(
			'section_alignment',
			[
				'label' => esc_html__( 'Alignment', 'elito-core' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'elito-core' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'elito-core' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'elito-core' ),
		...
		$this->add_control(
			'btn_paragraph',
			[
				'label' => esc_html__( 'Button/Paragraph Text', 'elito-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Button Paragraph Text', 'elito-core' ),
				'placeholder' => esc_html__( 'Type btn Paragraph text here', 'elito-core' ),
				'label_block' => true,
				'condition' => [
		...
		$this->start_controls_tabs( 'button_style' );
			...
			$this->add_control(
				'link_border_color',
				[
					'label' => esc_html__( 'Link Border Color', 'elito-core' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
...
Plugin::instance()->widgets_manager->register( new Elito_Button() );