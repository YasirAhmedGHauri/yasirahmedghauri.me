/*
 * All Admin Related Scripts in this Elito Theme
...
"use strict";
  ...
  /*---------------------------------------------------------------*/
   function elito_gutenberg_toggle_metaboxes() {
  ...
  function elito_toggle_metaboxes() {
  ...
  $(document).ready(function() {
      elito_gutenberg_toggle_metaboxes();
      elito_toggle_metaboxes();
    $('#post-formats-select input[type="radio"]').on('click', elito_toggle_metaboxes);
  });
