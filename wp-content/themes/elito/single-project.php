...
get_header();
	...
	// Theme Options
	$elito_sidebar_position = cs_get_option( 'project_sidebar_position' );
	$elito_single_comment = cs_get_option( 'project_comment_form' );
	$elito_sidebar_position = $elito_sidebar_position ? $elito_sidebar_position : 'sidebar-hide';
	// Sidebar Position
	if ( $elito_sidebar_position === 'sidebar-hide' ) {
		$elito_layout_class = 'col-lg-10 offset-lg-1 col-12';
		...
		$elito_layout_class = 'col col-lg-8';
		$elito_sidebar_class = 'right-sidebar';
	} ?>
<div class="wpo-project-single-area section-padding <?php echo esc_attr( $elito_content_padding .' '. $elito_sidebar_class ); ?>" style="<?php echo esc_attr( $elito_custom_padding ); ?>">
	<div class="container">
		<div class="row">
