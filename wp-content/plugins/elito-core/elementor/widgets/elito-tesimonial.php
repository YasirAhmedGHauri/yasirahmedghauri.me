                    ...
                    <div class="testimonial-left">
                        <div class="testimonial-left-inner">
                            ...
                            <div class="side-img-<?php echo esc_attr( $id ); ?>">
                             <?php if( $avatar_url ) { echo '<img src="'.esc_url( $avatar_url ).'" alt="'.esc_url( $avatar_alt ).'">'; } ?>
                            </div>
                            ...
                            <div class="wpo-testimonial-item">
                                <div class="wpo-testimonial-text">
                                    ...
                                    <div class="wpo-testimonial-text-btm">
                                        <h3><?php if( $testimonial_name ) { echo esc_html( $testimonial_name ); }  if( $testimonial_subtitle ) { echo '<span>'.esc_html( $testimonial_subtitle ).'</span>'; } ?></h3>
                                    </div>
                                </div>
                            </div>
                            <?php }
