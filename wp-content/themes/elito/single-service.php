...
get_header();
	...
	// Theme Options
	$elito_sidebar_position = cs_get_option( 'service_sidebar_position' );
	$elito_single_comment = cs_get_option( 'service_comment_form' );
	$elito_sidebar_position = $elito_sidebar_position ? $elito_sidebar_position : 'sidebar-hide';
	// Sidebar Position
	if ( $elito_sidebar_position === 'sidebar-hide' ) {
		$elito_layout_class = 'col col-lg-10 offset-lg-1';
...
<div class="wpo-service-details-area wpo-service-single-area section-padding <?php echo esc_attr( $elito_content_padding .' '. $elito_sidebar_class ); ?>" style="<?php echo esc_attr( $elito_custom_padding ); ?>">
	<div class="container">
		<div class="row">
